        ...
        try {
            ...
            while (true) {
                try {
                    ...
                    System.out.println("Invalid input format. Please enter an integer for the product stock.");
                    scanner.nextLine();
                }
            }
            ...
            String sql = "INSERT INTO Products (id, Category, Price, Brand, Description, Stock, Name) VALUES  (?, ?, ?, ?, ?, ?, ?)";
    ...
    private void deleteProduct(Connection conn) {
        try {
            ...
            if (resultSet.next()) {
                ...
                deletedStock = resultSet.getInt("Stock");
            ...
            System.out.println("Stock: " + deletedStock);
